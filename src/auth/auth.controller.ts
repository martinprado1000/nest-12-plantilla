...
export class AuthController {
  ...
  testingPrivateRoute(
    ...
    return {
      acceso: "Autorizado",
      messaage: 'Route PRIVATE. Acceso sin restricción, solo debe estar logueado',
    };
  }
  ...
  privateRoute3(@GetUser() user: User) {
    return {
      acceso: "Autorizado",
      messaage: 'Route 3, ACCESO PARA USUARIOS: SUPERADMIN. Esta ruta incluye el decorador "@GetUser() user: User" para obtener el usuario y agregarlo al request. ', 
      user,
    };
  }
}
